...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Users.Identify(context.Background(), userplex.UserIdentifyParams{
		UserID: "user_id",
		Email:  userplex.String("REPLACE_ME"),
		Name:   userplex.String("REPLACE_ME"),
	})
	if userAgent != fmt.Sprintf("Userplex/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Users.Identify(context.Background(), userplex.UserIdentifyParams{
		UserID: "user_id",
		Email:  userplex.String("REPLACE_ME"),
		Name:   userplex.String("REPLACE_ME"),
	})
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Users.Identify(cancelCtx, userplex.UserIdentifyParams{
		UserID: "user_id",
		Email:  userplex.String("REPLACE_ME"),
		Name:   userplex.String("REPLACE_ME"),
	})
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Users.Identify(deadlineCtx, userplex.UserIdentifyParams{
			UserID: "user_id",
			Email:  userplex.String("REPLACE_ME"),
			Name:   userplex.String("REPLACE_ME"),
		})
